...
def test_voice_family_key_merges_near_synonyms() -> None:
    ...
    assert _resolve_voice_family_key("请求") == "请求"
    assert _resolve_voice_family_key("认真") == "中性"
    assert _resolve_voice_family_key("自信") == "中性"
    assert _resolve_voice_family_key("困惑") == "中性"
